...
const iconContainer = document.querySelector(".btn__icon-container");
const iconArrow = [
`
...
let darkIconFlag = false;
iconContainer.innerHTML = iconArrow[0];

button.addEventListener("click", () => toggleIcon());

function toggleIcon() {
    iconContainer.innerHTML = darkIconFlag? iconArrow[0] : iconArrow[1];
    darkIconFlag = !darkIconFlag;
}